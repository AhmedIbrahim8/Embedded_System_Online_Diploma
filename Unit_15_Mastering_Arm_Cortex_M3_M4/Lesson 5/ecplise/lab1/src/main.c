...
#define  SWITCH_CPU_ACCESS_LEVEL_PRIV     __asm volatile(" mrs r3,CONTROL    \n\t" \
                                                         " lsr r3, r3, #0x01 \n\t" \
                                                         " lsl r3, r3, #0x01 \n\t" \
                                                         " msr CONTROL, r3 ");

#define  SWITCH_CPU_ACCESS_LEVEL_UNPRIV   __asm volatile(" mrs r3, CONTROL   \n\t" \
                                                         " orr r3, r3, #0x01 \n\t" \
                                                         " msr CONTROL, r3 ");
...
int TaskB(int a,int b,int c,int d,int e,int f)
{
	return a+b+c;
}
...
//			SWITCH_CPU_AccessLevel(UNPRIVILEGED);
			SWITCH_CPU_ACCESS_LEVEL_UNPRIV;

			TASKB_flag=TaskB(1,2,3,4,5,6);
